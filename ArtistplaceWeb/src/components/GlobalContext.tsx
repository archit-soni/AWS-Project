  ...
  render() {
    const renderUserView = () => {
      ...
      if (this.state.userInfo[this.state.currentuserindex] !== undefined) {
        ...
        return <UserHomeView updateUserList={this.newUserIsAdded} updatePrivateKey={this.storeAccountPrivateKey} updateBalance={this.updateEtherEscrowBalance} updateAssets={this.updateRegisteredAssetStatus} registeredAssets={this.state.assetInfo} appServiceObj={this.appService} ethUser={currentUser}></UserHomeView>
      }
      else {
        return <></>;
      }
    ...
    return (
      ...
      <Container fluid style={{
        backgroundImage: "linear-gradient(to right, #662D8C, #ED1E79)",
        backgroundSize:"100% 100%",
      }}>
        <Row className="justify-content-md-center" style={{
          backgroundColor:"#232f3f"
        }}>
          <a href="/"><h1 className="display-4 App-header">A R T I S T P L A C E</h1></a>
        </Row>
        <Row style={{
          marginBottom: "1%",
