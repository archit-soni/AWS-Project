...
export default class NewAsset extends React.Component<
  {},
  IGlobalContextState
> {
  ...
  render() {
    const renderUserView = () => {
      ...
      if (this.state.userInfo[this.state.currentuserindex] !== undefined) {
        ...
        return <UserRegisterView updateUserList={this.newUserIsAdded} updatePrivateKey={this.storeAccountPrivateKey} updateBalance={this.updateEtherEscrowBalance} updateAssets={this.updateRegisteredAssetStatus} registeredAssets={this.state.assetInfo} appServiceObj={this.appService} ethUser={currentUser}></UserRegisterView>
      }
      else {
        return <></>;
      }
